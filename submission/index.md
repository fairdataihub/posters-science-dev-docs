...
Through systematic evaluation on 400 posters from Zenodo and Figshare, Llama 3.1 8B significantly outperformed traditional NLP methods (Grobid) across all fields. The model is deployed on local GPU hardware using 4-bit quantization for optimized inference, targeting under 60 seconds per poster.
